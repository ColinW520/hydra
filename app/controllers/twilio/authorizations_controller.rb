class Twilio::AuthorizationsController < Twilio::BaseController
  def authorize
    ...
    store_feed_item(@organization, "#{@organization.name} connected its Twilio Account.")
  ...
  def deauthorize
    ...
    store_feed_item(@organization, "#{@organization.name} disconnected its Twilio Account")
  end
end
